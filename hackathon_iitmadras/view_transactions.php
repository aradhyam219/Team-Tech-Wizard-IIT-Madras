...
<h1 class="align-items-center">Transactions</h1><br>
            ...
            $select_display="SELECT * FROM transactions WHERE (balance_type = 'debit' AND login_username = '$login_username') OR (balance_type = 'credit' AND login_username = '$login_username') ORDER BY transfer_id" ;
