...
if(isset($_POST['check'])){
    ...
    $check_code = "SELECT * FROM application WHERE token = $otp_code";
    ...
    if(mysqli_num_rows($code_res) > 0){
        ...
        $update_otp = "UPDATE application SET token = $token,verification_status = '$verification_status' WHERE token = $fetch_code";
