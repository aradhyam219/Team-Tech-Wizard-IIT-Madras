...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql_email = "SELECT * FROM `card_account_details` WHERE email_id = '$email_id'";
    ...
    $sql = "UPDATE card_account_details SET transaction_attempts=0,password_token='$password_token',password_code=0 WHERE email_id='$email_id'";
                                    ...
                                    <tr>
                                        <td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;'>
                                            ...
                                            <div style='line-height: 26px;'>
                                                <a href='http://www.smilewellnessfoundation.org/hackathon_iitmadras/transaction_password_activate.php?password_token=".$password_token."' style='color: #ffffff; text-decoration: none;'>reset password </a>
                                            </div>
                                        </td>
                                    </tr>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-4">
     ...
     <form action="transaction_pin_locked.php" method="post">
