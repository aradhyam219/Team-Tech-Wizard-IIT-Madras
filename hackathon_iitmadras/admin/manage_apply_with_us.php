			...
			<div class="row">
                <div class="col-lg-9 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="manage_apply_with_us.php" method="POST">
							
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">Search customer user name </h6>
								</div>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select  * from application where login_username='$login_username'and permission='pending and verification_status=1' order by application_id asc " ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <div><br><br></div>";
        echo" <a class='btn btn-primary' href='add_account_details.php?application_id=$application_id'>add details</a>
        ";
...
";
        ...
        $select_display="select  * from application where permission='pending' and verification_status=1; " ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                    ...
                    $country=$row["country"];
                        ...
                        <div class='card' style='box-shadow: 0 0 0px rgb(0 0 0) !important;'>
                            <div class='card-body'>
                                ...
                                <div><br><br></div>
        ";
        echo" <a class='btn btn-primary' href='add_account_details.php?application_id=$application_id'>view details</a>
        ";
